...
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! koa-router */ "koa-router");
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(koa_router__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var koa_redis__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! koa-redis */ "koa-redis");
/* harmony import */ var koa_redis__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(koa_redis__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _dbs_models_users__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../dbs/models/users */ "./server/dbs/models/users.js");
/* harmony import */ var _utils_passport__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/passport */ "./server/interface/utils/passport.js");
/* harmony import */ var _dbs_config__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../dbs/config */ "./server/dbs/config.js");
/* harmony import */ var _utils_axios__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/axios */ "./server/interface/utils/axios.js");
...
let Store = new koa_redis__WEBPACK_IMPORTED_MODULE_1___default.a().client;
router.post("/signup", async ctx => {
  ...
  let user = await _dbs_models_users__WEBPACK_IMPORTED_MODULE_3__["default"].find({
    username
  });
  ...
  let nuser = await _dbs_models_users__WEBPACK_IMPORTED_MODULE_3__["default"].create({
    username,
    password,
    email
  });
  ...
  if (nuser) {
    let res = await _utils_axios__WEBPACK_IMPORTED_MODULE_6__["default"].post("/users/signin", {
      username,
      password
    });
...
koa_passport__WEBPACK_IMPORTED_MODULE_0___default.a.use(new passport_local__WEBPACK_IMPORTED_MODULE_1___default.a(async function (username, password, done) {
  let where = {
    username
  };
  let result = await _dbs_models_users__WEBPACK_IMPORTED_MODULE_2__["default"].findOne(where);
...
koa_passport__WEBPACK_IMPORTED_MODULE_0___default.a.serializeUser(function (user, done) {
  done(null, user);
});
koa_passport__WEBPACK_IMPORTED_MODULE_0___default.a.deserializeUser(function (user, done) {
  return done(null, user);
});
/* harmony default export */ __webpack_exports__["default"] = (koa_passport__WEBPACK_IMPORTED_MODULE_0___default.a);
